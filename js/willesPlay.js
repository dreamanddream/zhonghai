$(function() {
	...
	var container_lun=$(".container_lun");
	  var playContent =$(".playContent");
	var playControll=$(".playControll");
	...
	function playControl() {
			...
			if (playVideo[0].paused) {
				playVideo[0].play();
				container_lun.css("display","none");
                ...
                container_lun.css("display","block");
				 
 			playContent.css("display","none");
                playControll.css("display","none");
				$('.playTip').removeClass('glyphicon-pause').addClass('glyphicon-play').fadeIn();
